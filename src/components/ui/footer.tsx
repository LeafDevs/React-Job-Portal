...
// Footer component that accepts a 'string' prop to determine the style variant
export default function Footer({ string: className }: { string: string }) {
    // Render different footer styles based on the className prop
    return className === "blocky" ? (
        // Blocky style footer with solid background
        <footer className="bg-[#341A00] text-white py-8">
            <div className="container mx-auto px-4">
                {/* Three column grid layout for footer content */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            ...
                            <p>Email: mmawhinny@goldenrams.com</p>
                        </div>
                    </div>
                    {/* Quick links column */}
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="https://powerschool.goldenrams.com/public/home.html" className="text-[#C7AC59] hover:text-white transition-colors">Grades Portal</a></li>
                            <li><a href="https://www.goldenrams.com/domain/702" className="text-[#C7AC59] hover:text-white transition-colors">Student Resources</a></li>
                            <li><a href="https://www.goldenrams.com/directory" className="text-[#C7AC59] hover:text-white transition-colors">Staff Directory</a></li>
                        </ul>
                    </div>
                    {/* Social media column */}
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.facebook.com/HighlandsSD/" className="text-[#C7AC59] hover:text-white transition-colors">
                                <Facebook className="h-8 w-8" />
                            </a>
                            <a href="https://twitter.com/HighlandsSD" className="text-[#C7AC59] hover:text-white transition-colors">
                                <Twitter className="h-8 w-8" />
                            </a>
                            <a href="https://www.instagram.com/highlandsrams" className="text-[#C7AC59] hover:text-white transition-colors">
        ...
        // Curved style footer with SVG wave background
        <footer className="relative bg-[#341A00] text-white py-8">
            ...
            {/* Main content grid with z-index to appear above SVG */}
            ...
            {/* Copyright section with z-index to appear above SVG */}
